...
state("今日は左と上の数字を見てマス目を塗りつぶすアレを無限にやりたい！", "1.7.3-1.7.5")
{
    // memSize : 692224
    // fileVer : 6000.0.58.9625317
    // MD5hash : 42F4557B04AB8E322014C4F14BBFBD2E
    // MD5hash : 42F4557B04AB8E322014C4F14BBFBD2E
    // MD5hash : F75E4C17A4C0559CF120C0FAD4633BFD
...
state("今日は左と上の数字を見てマス目を塗りつぶすアレを無限にやりたい！", "1.7.6-1.7.7")
{
    // memSize : 692224
    // fileVer : 6000.0.58.9625317
    // MD5hash : 97621976F90215A799EA1CD34F5074FF
    // MD5hash : BD0CC7C47B818867BEF44BB2C188A7C0

    int scoreTotal:     "GameAssembly.dll", 0x02BCBCB0, 0xb8, 0x0, 0x70;
    int stageData:      "GameAssembly.dll", 0x02BCBCB0, 0xb8, 0x0, 0x320;
    double timeOnStage: "GameAssembly.dll", 0x02BCBCB0, 0xb8, 0x0, 0x238, 0x20, 0x28;
}
state("今日は左と上の数字を見てマス目を塗りつぶすアレを無限にやりたい！", "1.8.2")
{
    // memSize : 692224
    // fileVer : 6000.0.58.9625317
    // MD5hash : 858C481E6F54D195E5BD8DC4D9F861A7

    int scoreTotal:     "GameAssembly.dll", 0x02BD2FF0, 0xb8, 0x0, 0x70;
    int stageData:      "GameAssembly.dll", 0x02BD2FF0, 0xb8, 0x0, 0x330;
    double timeOnStage: "GameAssembly.dll", 0x02BD2FF0, 0xb8, 0x0, 0x248, 0x20, 0x28;
}

startup
{
    settings.Add("startToGenerate", false, "初回の問題生成をタイムに含める");
...
init
{
    ...
    switch (MD5Hash)
    {
        ...
        case "F75E4C17A4C0559CF120C0FAD4633BFD":
            version = "1.7.3-1.7.5";
            break;
        case "97621976F90215A799EA1CD34F5074FF":
        case "BD0CC7C47B818867BEF44BB2C188A7C0":
            version = "1.7.6-1.7.7";
            break;
        case "858C481E6F54D195E5BD8DC4D9F861A7":
            version = "1.8.2";
            break;
        default:
            version = "unknown";
...
start
{
    if (settings["startToGenerate"])
        return current.stageData > 0 && old.stageData == 0;
    
    return current.timeOnStage > old.timeOnStage;
}
onStart
{
    vars.totalTime = 0.0;
