...
## 主な機能
Beltmatic 用のAutoplitterです。

### Reach Level 10, 20, 30
|自動操作|説明|
|:--|:--|
|自動スタート|NEW GAME を開始した瞬間（ゲーム内の tick が 0 から増加した瞬間）|
|自動リセット|NEW GAME を開始した瞬間（ゲーム内の tick が 0 になった瞬間）|
|自動ラップ|Level が上昇した瞬間|
...
### 設定手順
1. Splits EditorのGame Nameに「Beltmatic」と入力します。
1. Activateボタンを押します。
