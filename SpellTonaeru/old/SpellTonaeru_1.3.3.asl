...
state("game", "1.10.0")
{
    ...
    int pauseType : "game.exe", 0x02BEE090, 0x488, 0x1d0, 0x20, 0x68, 0x28, 0x8;
...
state("game", "1.10.1-1.10.4")
{
    // memSize : 49123328
    // fileVer : 1.0.0.0
    // MD5Hash : A1DED91EB97BE6667FFB71ABEBD365E9
    // MD5Hash : 77D17B055CA431C0DFB3ACFB900B3C3D
    // MD5Hash : 097D8CC982BF1F1D9BE8A4976B681011

    // memSize : 47411200
    // MD5Hash : 3623BD245018975781281F750837F0DE

    int scene :     "game.exe", 0x02A34458, 0x468, 0x1b8,  0x0, 0x68, 0x28, 0x50;
    int ending :    "game.exe", 0x02A34458, 0x348, 0x1b8, 0x88, 0x68, 0x28, 0x20;
    int stage :     "game.exe", 0x02A34458, 0x348, 0x1b8, 0x68, 0x68, 0x28, 0x8;
    int pauseType : "game.exe", 0x02A34458, 0x468, 0x1b8, 0x20, 0x68, 0x28, 0x8;

    int igt :       "game.exe", 0x02A34458, 0x348, 0x1b8, 0x48, 0x68, 0x28, 0x8;
    bool isBattle : "game.exe", 0x02A34458, 0x348, 0x1b8, 0x48, 0x68, 0x28, 0x68;
}
state("game", "1.11.0")
{
    // memSize : 47411200
    // fileVer : 1.0.0.0
    // MD5Hash : 53788D6A4079130B06E488BB270F7476

    int scene :     "game.exe", 0x02A34458, 0x468, 0x1b8,  0x0, 0x68, 0x28, 0x50;
    int ending :    "game.exe", 0x02A34458, 0x348, 0x1b8, 0x90, 0x68, 0x28, 0x20;
    int stage :     "game.exe", 0x02A34458, 0x348, 0x1b8, 0x70, 0x68, 0x28, 0x8;
    int pauseType : "game.exe", 0x02A34458, 0x468, 0x1b8, 0x30, 0x68, 0x28, 0x8;

    int igt :       "game.exe", 0x02A34458, 0x348, 0x1b8, 0x50, 0x68, 0x28, 0x8;
    bool isBattle : "game.exe", 0x02A34458, 0x348, 0x1b8, 0x50, 0x68, 0x28, 0x68;
}
state("game", "1.11.3-1.12.0")
{
    // memSize : 57339904
    // fileVer : 1.0.0.0
    // MD5Hash : 0EFDE6530792BC2D79FE6ED066DED344
    // MD5Hash : AE4DA3C22166E9655506EA3B88B1E924

    int scene :     "game.exe", 0x0338FA58, 0x438, 0x188,  0x0, 0x60, 0x28, 0x50;
    int ending :    "game.exe", 0x0338FA58, 0x318, 0x188, 0x90, 0x60, 0x28, 0x20;
    int stage :     "game.exe", 0x0338FA58, 0x318, 0x188, 0x70, 0x60, 0x28, 0x8;
    int pauseType : "game.exe", 0x0338FA58, 0x438, 0x188, 0x30, 0x60, 0x28, 0x8;

    int igt :       "game.exe", 0x0338FA58, 0x318, 0x188, 0x50, 0x60, 0x28, 0x8;
    bool isBattle : "game.exe", 0x0338FA58, 0x318, 0x188, 0x50, 0x60, 0x28, 0x68;
}
state("game", "1.13.0-1.13.2")
{
    // memSize : 57339904
    // fileVer : 1.0.0.0
    // MD5Hash : 756266726F3FC7A43513D4273653F985
    // MD5Hash : 173327843AEC3191CA6A24FF6ECD1724
    // MD5Hash : 0A029B7AED2D32838C24084F311BFAA4

    int scene :     "game.exe", 0x0338FA58, 0x438, 0x188,  0x0, 0x60, 0x28, 0x50;
    int ending :    "game.exe", 0x0338FA58, 0x318, 0x188, 0x98, 0x60, 0x28, 0x20;
    int stage :     "game.exe", 0x0338FA58, 0x318, 0x188, 0x78, 0x60, 0x28, 0x8;
    int pauseType : "game.exe", 0x0338FA58, 0x438, 0x368,  0x8, 0x60, 0x28, 0xc8;

    int igt :       "game.exe", 0x0338FA58, 0x318, 0x188, 0x58, 0x60, 0x28, 0x8;
    bool isBattle : "game.exe", 0x0338FA58, 0x318, 0x188, 0x58, 0x60, 0x28, 0x68;
}
...
init
{
    ...
    switch (MD5Hash)
    {
        ...
        case "094B70001A212DB5DE1773DF38AB1C83":
            version = "1.10.0";
            break;
        case "A1DED91EB97BE6667FFB71ABEBD365E9":
        case "77D17B055CA431C0DFB3ACFB900B3C3D":
        case "097D8CC982BF1F1D9BE8A4976B681011":
        case "3623BD245018975781281F750837F0DE":
            version = "1.10.1-1.10.4";
            break;
        case "53788D6A4079130B06E488BB270F7476":
            version = "1.11.0";
            break;
        case "0EFDE6530792BC2D79FE6ED066DED344":
        case "AE4DA3C22166E9655506EA3B88B1E924":
            version = "1.11.3-1.12.0";
            break;
        case "756266726F3FC7A43513D4273653F985":
        case "173327843AEC3191CA6A24FF6ECD1724":
        case "0A029B7AED2D32838C24084F311BFAA4":
            version = "1.13.0-1.13.2";
            vars.sceneInitialStart = 16;
            vars.sceneEnding = 6;
            break;
        default:
            version = "Unknown";
...
update
{
    ...
    // エンディング表示時の処理
    if (current.scene == vars.sceneEnding && old.scene != vars.sceneEnding)
    {
...
start
{
    if ((current.scene == 1 || current.scene == vars.sceneInitialStart) && (old.scene == 0 || old.scene == 4))
    {
        print("-- start --");
        return true;
    }
...
split
{
    ...
    if (vars.isFirstEventBattle)
    {
        ...
        if (current.stage == 1 && current.isBattle && old.isBattle)
        {
            vars.isFirstEventBattle = false;
        }
        else if (current.scene != 1 && old.scene == 1)
        {
