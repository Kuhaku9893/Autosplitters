...
- 初回演出から始めた際、1 日目の戦闘が始まるまではタイマー上の IGT は 0 を表示します。<br>
初回演出のイベント戦闘でもゲーム内部では IGT がカウントされてはいますが、初回演出を始める直前のプレイでの IGT がリセットされずに引き継がれているという仕様があります。<br>
ゲーム内部の IGT は 1 日目の戦闘開始時にリセットされる仕様であり、そのタイミングでタイマー上の IGT のカウントを開始するのが妥当だと判断しました。
