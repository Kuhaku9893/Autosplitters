...
start
{
    ...
    {
		print("start");
		print("current.mainChap : " + current.mainChap);
		print("current.subChap : " + current.subChap);
		print("current.notMenuFlg : " + current.notMenuFlg);
		print("old.notMenuFlg : " + old.notMenuFlg);
		return true;
    }
}
...
reset
{
	if(current.notMenuFlg == 0 && current.isGameModeFlg == 0)
	{
		print("reset");
		print("current.notMenuFlg : " + current.notMenuFlg);
		print("current.isGameModeFlg : " + current.isGameModeFlg);
		return true;
	}
} 
